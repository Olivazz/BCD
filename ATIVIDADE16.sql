...
SELECT PrimeiroNome, SegundoNome, UltimoNome, Salario, CPF FROM Funcionarios WHERE Salario>'4000';
-- 2. Selecione o salário máximo entre os funcionários que nasceram entre 1980 e 1990.
SELECT PrimeiroNome, SegundoNome, UltimoNome, Salario, DataNasci FROM Funcionarios WHERE DataNasci='1980, 1981, 1982, 1983, 1984, 1985, 1986, 1987, 1988, 1989, 1990';
-- 3. Selecione a média de salários dos funcionários que trabalham como Analista.
SELECT Funcao AVG,(Salario) AS Media FROM Funcionarios WHERE Funcao='Analista';
-- 4. Selecione o número de funcionários que têm "Oliveira" em seu sobrenome.
SELECT PrimeiroNome, SegundoNome, UltimoNome FROM Funcionarios WHERE SegundoNome Like '%Oliveira' or UltimoNome Like '%Oliveira';
...
SELECT Salario, PrimeiroNome, SegundoNome, UltimoNome, count(Codigo) AS NumFuncionarios FROM Funcionarios Where Salario ='3800';
-- 7. Selecione o salário-mínimo entre os funcionários que não têm CPF cadastrado.
SELECT min(Salario) AS Minimo FROM Funcionarios WHERE CPF is null ;
